...
{
  "scripts": {
    "build:pages": "ejsc \"template/**/*\"",
    "build:pages:large": "node --expose-gc --max-old-space-size=4096 ./node_modules/@wcj/ejs-cli/lib/cli.mjs \"template/**/*\"",
    "build:pages:large:watch": "node --expose-gc --max-old-space-size=4096 ./node_modules/@wcj/ejs-cli/lib/cli.mjs \"template/**/*\" --watch"
  }
}
```
...
{
  "scripts": {
    "build:pages:heap": "cross-env NODE_OPTIONS=--max-old-space-size=4096 ejsc \"template/**/*\""
  }
}
```
